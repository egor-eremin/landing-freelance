...
(function showMoreProject() {
  ...
  $('.projects-wrapper').each(function () {
    if ($(this).find('.projects-item').length <= 3) {
      ...
      $(this).css('max-height', "".concat(startHeight - 1, "px"));
    }
  });
  $('.btn-show-more').on('click', function () {
    ...
    var currentMaxHeight = parseInt(thisProjectWrapper.css('max-height'), 10);
    thisProjectWrapper.css('max-height', "".concat(hideElementHeight + currentMaxHeight, "px"));
    hideElement.removeClass('hide-project');
    if (hideElement.next().length === 0) {
      setTimeout(function () {
        $('.btn-show-more').addClass('hide').next('.all-projects').removeClass('hide');
      }, 300);
    }
  });
})();
...
(function printedText() {
  $('.welcom-block').viewportChecker({
    ...
    callbackFunction: function callbackFunction() {
      setTimeout(function () {
        var textTyped = new typed_js__WEBPACK_IMPORTED_MODULE_0___default.a('.typed-text', {
...
__webpack_require__(/*! ./vendor/inputmask.min */ "./src/js/vendor/inputmask.min.js");
...
__webpack_require__(/*! ./vendor/owl.carousel.min */ "./src/js/vendor/owl.carousel.min.js");
__webpack_require__(/*! ./vendor/pathAnimator */ "./src/js/vendor/pathAnimator.js");
$(document).ready(function () {
  __webpack_require__(/*! ./blocks/header */ "./src/js/blocks/header.js");
  __webpack_require__(/*! ./blocks/projects */ "./src/js/blocks/projects.js");
  __webpack_require__(/*! ./blocks/reviews */ "./src/js/blocks/reviews.js");
  __webpack_require__(/*! ./blocks/up-top */ "./src/js/blocks/up-top.js");
  __webpack_require__(/*! ./blocks/welcom */ "./src/js/blocks/welcom.js");
  __webpack_require__(/*! ./blocks/reviews */ "./src/js/blocks/reviews.js");
  ...
  (function openPopup() {
    $('body').on('mousemove', '.upload-list__item', function (e) {
  ...
  (function animationGorizontalBlock() {
    ...
    $('.gorizontal-block').each(function (index, value) {
      var frame_count = $(this).find('.gorizontal-item').length;
      var wrapperWidth = $(this).find('.template-wrapper_gorizontal-block').innerWidth();
      var frameWidth = $(this).find('.gorizontal-item').outerWidth(true);
      var widthAllFrame = frameWidth * frame_count;
      var difference = widthAllFrame - wrapperWidth;
      var animationElement = value.getElementsByClassName('gorizontal-wrapper');
      var offsetTop = parseInt($(this).find('.template-wrapper_gorizontal-block').css('padding-top')) + $(this).find('.main-h2').outerHeight() + parseInt($(this).find('.gorizontal-wrapper').css('margin-top')) + $(this).find('.gorizontal-wrapper').outerHeight() / 2;
...
function addedNewFile(id, file) {
  if (file.type == 'image/png' || file.type == 'image/jpeg' || file.type == 'image/jpg' || file.type == 'image/gif') {
    ...
    $('<li class="upload-list__item upload-list__item_not-image" id="' + id + '">' + '<span class="percent-number"></span>' + '<button class="close-file-button">' + '<?xml version="1.0" encoding="UTF-8"?>\n' + '<svg class="close-file-item" width="8px" height="8px" viewBox="0 0 8 8" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">\n' + '    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">\n' + '        <g transform="translate(-173.000000, -2086.000000)" fill="#B9B9BF">\n' + '            <g transform="translate(169.000000, 2082.000000)">\n' + '                <g transform="translate(2.000000, 2.000000)">\n' + '                    <g transform="translate(6.000000, 6.000000) rotate(-45.000000) translate(-6.000000, -6.000000) translate(2.000000, 2.000000)">\n' + '                        <path d="M4.66666667,3.33333333 L7.5,3.33333333 C7.77614237,3.33333333 8,3.55719096 8,3.83333333 L8,4.16666667 C8,4.44280904 7.77614237,4.66666667 7.5,4.66666667 L4.66666667,4.66666667 L4.66666667,7.5 C4.66666667,7.77614237 4.44280904,8 4.16666667,8 L3.83333333,8 C3.55719096,8 3.33333333,7.77614237 3.33333333,7.5 L3.33333333,4.66666667 L0.5,4.66666667 C0.223857625,4.66666667 -1.30165146e-15,4.44280904 -1.30165146e-15,4.16666667 L-1.30165146e-15,3.83333333 C-1.30165146e-15,3.55719096 0.223857625,3.33333333 0.5,3.33333333 L3.33333333,3.33333333 L3.33333333,0.5 C3.33333333,0.223857625 3.55719096,0 3.83333333,0 L4.16666667,0 C4.44280904,0 4.66666667,0.223857625 4.66666667,0.5 L4.66666667,3.33333333 Z"></path>\n' + '                    </g>\n' + '                </g>\n' + '            </g>\n' + '        </g>\n' + '    </g>\n' + '</svg>' + '</button><span class="name-file" data-id-text="' + id + '">' + file.name + '</span></li>').appendTo('.upload-list');
  }
}
;
...
function validationForm(formInit) {
  ...
  $(formInit).validate({
    ...
    submitHandler: function submitHandler(form) {
      var currentEmail = $('.form-input[type="email"]').val();
      $.ajax({
...
/* harmony import */ var dm_file_uploader__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! dm-file-uploader */ "./node_modules/dm-file-uploader/src/js/jquery.dm-uploader.js");
/* harmony import */ var dm_file_uploader__WEBPACK_IMPORTED_MODULE_7___default = /*#__PURE__*/__webpack_require__.n(dm_file_uploader__WEBPACK_IMPORTED_MODULE_7__);
...
!function webpackUniversalModuleDefinition(root, factory) {
  if ("object" == (typeof exports === "undefined" ? "undefined" : _babel_runtime_helpers_typeof__WEBPACK_IMPORTED_MODULE_0___default()(exports)) && "object" == ( false ? undefined : _babel_runtime_helpers_typeof__WEBPACK_IMPORTED_MODULE_0___default()(module))) module.exports = factory();else if ("function" == typeof define && __webpack_require__(/*! !webpack amd options */ "./node_modules/webpack/buildin/amd-options.js")) define([], factory);else {
    var a = factory();
    for (var i in a) ("object" == (typeof exports === "undefined" ? "undefined" : _babel_runtime_helpers_typeof__WEBPACK_IMPORTED_MODULE_0___default()(exports)) ? exports : root)[i] = a[i];
  }
}(window, function () {
...
!function webpackUniversalModuleDefinition(root, factory) {
  ...
  return modules = [function (module, exports, __webpack_require__) {
    ...
    function parse(format, dateObjValue, opts, raw) {
      for (var mask = "", match; match = getTokenizer(opts).exec(format);) if (void 0 === dateObjValue) {
        if (formatCode[match[0]]) mask += "(" + formatCode[match[0]][0] + ")";else switch (match[0]) {
          case "[":
            mask += "(";
            break;
...
PathAnimator.prototype = {
  start: function start(startFromPercent, stopAtPercent) {
    this.stop();
  ...
  stopAt: function stopAt(percent) {},
  pointAt: function pointAt(percent) {
